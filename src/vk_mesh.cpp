...
VertexInputDescription VertexOpengl::get_vertex_description() {
  VertexInputDescription description;
...
bool Mesh::load_from_obj(const char *filename) {
  auto fullpath = std::string(PROJECT_ROOT_PATH) + "/" + filename;
  auto asset_path = std::string(PROJECT_ROOT_PATH) + "/" + "assets";
