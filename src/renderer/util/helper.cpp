...
void Helper::load_image_slices(const char *file,
                               std::vector<AllocatedImage> &outImage,
  ...
  AllocatedBuffer stagingBuffer = Helper::create_buffer(
  ...
  vmaCreateImage(Helper::allocator, &dimg_info, &dimg_allocinfo,
  ...
  vmaDestroyBuffer(Helper::allocator, stagingBuffer._buffer,
                   stagingBuffer._allocation);
