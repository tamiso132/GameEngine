...
AllocatedBuffer create_buffer(VmaAllocator allocator, size_t allocSize, VkBufferUsageFlags usage,
...
//   // allocate the buffer@
//   VK_CHECK(vmaCreateBuffer(allocator, &stagingBufferInfo, &vmaallocInfo, &stagingBuffer._buffer,
//                            &stagingBuffer._allocation, nullptr));

//   // copy vertex data
//   void *data;gpuPropertiesfer._allocation);
...
//   // allocate the buffer
//   VK_CHECK(vmaCreateBuffer(allocator, &vertexBufferInfo, &vmaallocInfo, &mesh._vertexBuffer._buffer,
...
void Helper::init(VkDevice device, VkPhysicalDeviceProperties gpuProperties, VmaAllocator allocator) {
...
size_t Helper::pad_uniform_buffer_size(size_t originalSize) {
  ...
  size_t minUboAlignment = Helper::gpuProperties.limits.minUniformBufferOffsetAlignment;
