...
bool vkutil::load_image_from_file(VulkanEngine &engine, const char *file, AllocatedImage &outImage) {
  ...
  //       engine.create_buffer(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VMA_MEMORY_USAGE_CPU_ONLY);
  ...
  //   // 										{
  //   vmaDestroyImage(engine._allocator,
  //   // newImage._image, newImage._allocation); });
